...
All computational methods rely on widely available open-source Python libraries such as \textbf{networkx} and \textbf{numpy}, ensuring the accessibility, reproducibility, and transparency of the modeling framework.
