...
\section*{Limitations}
Our current experiments are bounded by computational power. In particular we are only able to run our experiments on networks of a few thousand nodes, importantly the results may vary for out of distribution networks. Comparing various measures of topology against our results is also not especially tractable, for example the small worlds coefficient
